    ...
    var checkPass = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#selectList_edit_pass').html(str);
                $('#selectList_edit_pass').trigger('change');
            },
            error: function (data) {
                console.log(JSON.stringify(data,null,4));
            }
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data!=null){
                        ...
                        //更新界面的html
                        var dt = $('#sample_editable_pass').dataTable();
                        $('#sample_editable_pass').dataTable().fnClearTable();
        ...
        $('#btn_distr_edit_passEdit').click(function () {
            ...
            params.noticetype_code= $('#selectList_edit_pass').val();
...
/*
        ...
        $('#btn_upload').click(function () {
            ...
            var table = $('#sample_editable_pass');
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data!=null){
                            ...
                            $('#selectList_edit_pass').val(data.noticetype.noticetype_code);
                            $('#selectList_edit_pass').trigger('change');
