 ...
 */
var AdminUnpassEditors = function () {
    ...
    var checkUnPass = function () {
        ...
        function refresh(){
            ...
            console.log("unpass:"+JSON.stringify(params.user_code));
            $.ajax({
                async: false,
                type: "POST",
                url: "../../check/loadunpassednoticeByuser",
                data: params,
                dataType: "json",
                success: function (data) {
                    if(data!=null){
        ...
        var tableWrapper = $("#sample_editable_unpass_wrapper");
