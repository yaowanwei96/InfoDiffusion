...
(function ($) {
    ...
    $.fn.editableform.template = '<form class="form-inline editableform">'+
        ...
        '<div><div class="editable-input"></div><div  class="editable-buttons" style="height:auto;width:90%;"></div></div>'+
...
(function ($) {
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-sm blue editable-submit"><i class="fa fa-check"></i>确认</button>'+
        '<button type="button" class="btn btn-sm default editable-cancel float-right"><i class="fa fa-times"></i>取消</button>';
